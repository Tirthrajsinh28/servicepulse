...
/**
 * Synthetic frontend-only adapter for screenshots and local UI demos.
 *
 * This adapter intentionally does not represent a live backend, production
 * data, cloud execution, or employer work. Enable it only with
 * `VITE_SERVICEPULSE_DEMO_MODE=true`.
 */
export class DemoServicePulseApi implements ServicePulseApi {
